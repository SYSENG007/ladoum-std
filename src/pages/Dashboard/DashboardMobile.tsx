...
export const DashboardMobile: React.FC = () => {
    ...
    return (
        <div className="h-full flex flex-col overflow-hidden">
            ...
            {/* Bottom Navigation */}
            <div className="flex-shrink-0 border-t border-slate-200 bg-white pt-2 pb-1 -mx-4 px-4">
                <div className="flex items-center justify-around">
                    <button onClick={() => navigate('/')} className="flex flex-col items-center gap-0.5 text-emerald-600">
                    ...
                    <button onClick={() => navigate('/herd')} className="w-11 h-11 bg-emerald-500 rounded-full flex items-center justify-center shadow-lg -mt-4">
